...
This is to simulate a change made on a robot: robot_speed = 15 # m/s
"""

def main():
    print("Hello World!")

    name = "Brynn Frei" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("I like to eat cookies!")
